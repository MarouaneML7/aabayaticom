...
const HeroSection = () => {
  return (
    <section className="relative w-full min-h-[100svh] flex flex-col">
      ...
      <div className="relative mt-auto px-5 pb-8 pt-16 text-right">
        ...
        <p className="font-body text-base font-light text-alabaster/90 mb-6 leading-relaxed max-w-md mr-0 ml-auto">
          وفري عليك عناء البحث! طقم متكامل كيجمع بين الحشمة والجمال، متوفر بألوان ساحرة وفصالة مريحة كتناسب الجميع.
        </p>

        {/* Price tag */}
        <div className="inline-flex items-center gap-3 bg-alabaster/10 backdrop-blur-md rounded-lg px-5 py-3 border border-alabaster/20">
