const FloatingWhatsApp = () => {
  return (
    <a
      href="https://wa.me/212772967342" // لا تنسَ وضع رقمك هنا
      target="_blank"
